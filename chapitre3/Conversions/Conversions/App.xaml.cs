...
namespace Conversions
{
    public partial class App : Application
    {
        ...
        {
            MessageBox.Show("Voici le détail de l'erreur: " + e.ExceptionObject.Message,"Une exception est survenue !" , MessageBoxButton.OK);
            // On peut ainsi continuer l'exécution du programme
            e.Handled = true;
        }
